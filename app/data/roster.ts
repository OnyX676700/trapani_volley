...
export const ROSTER: { stagione: string; femminile: Athlete[]; maschile: Athlete[] } = {
  ...
  femminile: [
    ...
    { number: "13", name: "Deborah", surname: "Dell'Utri", role: "In attesa di ruolo", image: "" },
      ...
      nationality: "Italia",
      nationalityCode: "ita",
      birthplace: "Castelvetrano (TP)",
      birthday: "04/01/2006",
      height: 168,
      carriera: [
        { period: "2025–2026", team: "Trapani Volley", category: "Trasferimento e prosecuzione dell'attività agonistica" },
        { period: "Anni universitari", team: "Ericina", category: "Esperienza maturata durante gli studi a Trapani" },
        { period: "Prima Divisione", team: "Salemi Volley Project", category: "Passaggio al ruolo di Centrale, mantenuto fino alla stagione 2025/2026" },
        { period: "Settore giovanile", team: "Salemi Volley Project", category: "Ruolo di Palleggiatrice, dopo aver iniziato come Opposto" },
        { period: "Dal 2014", team: "Salemi Volley Project", category: "Inizio del percorso pallavolistico" },
      ],
    },
    {
      number: "10",
