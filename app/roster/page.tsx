...
const ROSTER: { stagione: string; femminile: Athlete[]; maschile: Athlete[] } = {
  ...
  femminile: [
    ...
    { number: "12", name: "Claudia", surname: "Morghese", role: "In attesa di ruolo", image: "" },
  ],
  maschile: [],
};
                ...
                {groupedAthletes[role].map((atleta, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {/* Numero Maglia */}
                      {atleta.number && (
                        <div style={{ position: "absolute", top: 12, right: 14, fontFamily: "'Playfair Display',serif", fontSize: "1.4rem", fontWeight: 900, color: "rgba(255,255,255,0.85)" }}>
                          #{atleta.number}
                        </div>
                      )}
